...
class Town(object):
	def __init__(self, screen, winx, winy, party, music):
		self.screen = screen
		self.winx = winx
		self.winy = winy
		self.party = party
				...
				if event.type == pygame.KEYDOWN:
					...
					if event.key == pygame.K_z:
						...
						if townselecty == int((self.winy*9)/20) + 50:
							print "Inn"		
							small = pygame.font.Font(None, 26)
							rest = "Your party's max hp increases slightly."
							framecount = 0

							if self.party[0].food == 1:
								rest = "You have already eaten"
								rest_t = small.render(rest, 1, WHITE)
								while framecount < 120:
									pygame.draw.rect(self.screen, WHITE, (198, 208, 454, 54))
									pygame.draw.rect(self.screen, GREY, (200, 210, 450, 50))
						...
						if townselecty == int((self.winy*9)/20) + 100:
							small = pygame.font.Font(None, 26)
							rest = "Your party's max mp increases slightly."
							framecount = 0

							if self.party[0].drink >= 1:
								rest = "You drink, but nothing happens"
								rest_t = small.render(rest, 1, WHITE)
								while framecount < 120:
									pygame.draw.rect(self.screen, WHITE, (198, 208, 454, 54))
									pygame.draw.rect(self.screen, GREY, (200, 210, 450, 50))
						...
						if townselecty == int((self.winy*9)/20) + 150:
							small = pygame.font.Font(None, 26)
							rest = "Your party's max mp increases more than normal."
							framecount = 0
